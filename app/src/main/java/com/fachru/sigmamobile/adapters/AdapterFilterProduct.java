 ...
 */
public class AdapterFilterProduct extends BaseAdapter implements Filterable {
	...
	private String label1, label2, sell_price, stock;

	public AdapterFilterProduct(Context context, List<HashMap<String, String>> datas) {
	...
	public View getView(int i, View view, ViewGroup viewGroup) {
		...
		if (view == null) {
			view = mInflater.inflate(R.layout.item_filter_product, null);
